...
class HistoryWindow(QWidget):
    def __init__(self):
        ...
        titleLbl.setFont(Bin.textFont)

        clearBtn = QPushButton("Clear")
        clearBtn.setObjectName("ClearButnHistory")
        clearBtn.setFont(Bin.textFont)
        ...
        # self.historyList.verticalScrollBar().setEnabled(True)
    ...
    def clearHistory(self):
        ...
        Bin.cursor.execute("DELETE FROM history")
