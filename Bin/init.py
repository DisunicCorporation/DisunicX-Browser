...
# # DB to open
# connection = sqlite3.connect("BrowsingDatabaseIncognito.db", check_same_thread=False)
...
if os.path.isfile("Incognito_Settings.json"):  # If settings file exists, then open it
    with open("Incognito_Settings.json", "r") as f:
        settings_data = json.load(f)
else:  # If settings not exists, then create a new file with default settings
    json_data = json.loads(
    """
    {
        "defaultSearchEnginein": "Google",
        "startupPagein": "https://disunicx.github.io/in.html",
        "newTabPagein": "https://disunicx.github.io/in.html",
        "homeButtonPagein": "https://disunicx.github.io/in.html"
    }
    """
    )
...
def main():
    ...
    # Set the window name
    QApplication.setApplicationName("DisunicX Incognito")

    # Set the window icon
    QApplication.setWindowIcon(QIcon(os.path.join("VisualElements", "logos", "browser.png")))
